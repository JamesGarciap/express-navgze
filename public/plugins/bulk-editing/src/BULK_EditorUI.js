...
ForgePlugins.EditorUI.prototype =
{
    ...
    { 
        console.log("Hotspot")
        console.log(this._editor.viewer.hotspots.all)

         if(this._editor.viewer.hotspots.all.length != 0){
            this._editor.selected= this._editor.viewer.hotspots.all[0].name
        }
      //  console.log("Delete UId "+this._editor.selected)
    ...
    {
        console.log("delete handler:"+this._editor.selected)
        this._editor.delete(this._editor.selected);
        this._updateList();
    },
    ...
    _updateList: function()
    {
       ...
       /* console.log("Update list Viewer");
        console.log(viewer)
        console.log("Update list hotspot")
    ...
    _hotspotListClickHandler: function(event)
    {
        ...
        this.HotspotChange[0] = event.target.name;
        //event.target.className = "selected"; 
        //this.HotspotChange.push(event.target.name);
        console.log(this.HotspotChange)
    },
